...
This downloads the latest versioned bundle from GitHub Releases, places all managed files in `.github/agents/`, `.github/skills/`, `.github/instructions/`, `.github/prompts/`, and `.agents/skills/`, writes `.dev-tasks-version` for traceability, and prints an **AGENTS.md integration prompt** showing what changed.
...
├── .agents/skills/            # Third-party imported skills
...
| `.agents/skills/*/SKILL.md` | Third-party skills |
