...
function fetchSingleManifest(entry: RegistryEntry, registryDir: string): FetchedManifest {
  ...
  // component.json is the canonical manifest format (PRD RF-20, spec §4.5/§5.2).
  // It is machine-generated by `dt extract component` and machine-validated by
  // ajv; its bytes are hashed for manual-edit detection, so the format is fixed.
