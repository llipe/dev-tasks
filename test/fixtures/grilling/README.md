...
#216, story S-004), and for the Phase 3 vocabulary work —
`activity-refine`'s glossary append (issue #231, story S-003) and
`activity-grill`'s FR-21 conflict rule (issue #232, story S-004).
...
| `vocabulary-conflict.md`         | WHAT-phase grilling: a term the user names is a forbidden synonym of an existing glossary entry, so the skill asks instead of resolving — with the same-definition reuse case and the one-question-naming-both case — and writes nothing to the glossary | S-004-AC-1, S-004-AC-4, FR-21, AC-08, D-61 |
