...
| TypeScript config | strict, ESM, outDir, path aliases | `tsconfig.json`: strict=true, module=NodeNext, outDir=dist/, paths for #core/* and #adapters/* | **Pass** |
...
*Note: This audit was conducted via grey-box source code review. Test execution was not possible in the current environment. All drift findings are non-blocking.*
