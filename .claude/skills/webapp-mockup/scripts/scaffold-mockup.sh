...
usage() {
  cat <<'USAGE'
Usage:
  ./.claude/skills/webapp-mockup/scripts/scaffold-mockup.sh <feature> <num> [palette_url]

Examples:
  ./.claude/skills/webapp-mockup/scripts/scaffold-mockup.sh onboarding 1
  ./.claude/skills/webapp-mockup/scripts/scaffold-mockup.sh billing 2 https://colorhunt.co/palette/281c594e8d9c85c79aedf7bd
USAGE
}
