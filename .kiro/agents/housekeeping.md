...
This agent will **not** change test logic, business logic, or package versions without explicit confirmation. Logic changes and package upgrades are escalated with a clear report — never applied silently.
