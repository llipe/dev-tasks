...
| [ADR-008](ADR-008-grilling-exit-gate-and-install-if-absent-category.md) | `activity-grill`'s hard exit gate, and the platform-agnostic install-if-absent category | Accepted              |
